...
class ActivityManager {
    ...
    static getCanvasControlsHTML() {
        ...
        return `
                    ...
                    <!-- Separator between colours and pen sizes -->
    ...
    async startActivityLogic(activityName) {
        switch (activityName) {
            ...
            case 'sorting':
                ...
                break;
            case 'trophy_room':
                // Trophy room is rendered by rewards manager after content loads
                if (window.rewardsManager) {
                    await window.rewardsManager.loadProgress();
                    window.rewardsManager.renderTrophyRoom();
                }
                break;
            default:
    ...
    loadActivityContent(activityName) {
        ...
        switch (activityName) {
            ...
            case 'sorting':
                ...
                break;
            case 'trophy_room':
                content = this.getTrophyRoomContent();
                break;
            default:
        ...
        return `
            <div class="activity-container memory-game-activity">
                ...
                <div class="difficulty-selector" id="memoryDifficulty">
                    <button class="difficulty-btn active" data-difficulty="easy">Easy (6)</button>
                    <button class="difficulty-btn" data-difficulty="medium">Medium (12)</button>
                    <button class="difficulty-btn" data-difficulty="hard">Hard (16)</button>
                </div>
    ...
    getJigsawContent() {
        return `
            <div class="activity-container jigsaw-activity">
                ...
                <div class="jigsaw-board-area" id="jigsawBoardArea">
                    <canvas id="jigsawBoardCanvas" width="400" height="400"></canvas>
                </div>

                <!-- Pieces Tray -->
                <div class="jigsaw-pieces-tray" id="jigsawPiecesTray">
                    <!-- Piece canvases generated by JS -->
                </div>
    ...
    getSortingContent() {
        return `
            <div class="activity-container sorting-activity">
                ...
                <!-- Difficulty Selector -->
                <div class="difficulty-selector" id="sortingDifficulty">
                ...
                <div class="sorting-category-scroll" id="sortingCategory">
                    ...
                    <button class="difficulty-btn" data-category="weather">Weather</button>
                    <button class="difficulty-btn" data-category="vehicles">Vehicles</button>
                    <button class="difficulty-btn" data-category="emotions">Emotions</button>
                    <button class="difficulty-btn" data-category="nature">Nature</button>
                    <button class="difficulty-btn" data-category="hot_cold">Hot & Cold</button>
                    <button class="difficulty-btn" data-category="day_night">Day & Night</button>
                </div>
    ...
    getTrophyRoomContent() {
        return `
            <div class="activity-container trophy-room-container">
                <h2 class="display-5 fw-bold mb-2">Trophy Room</h2>
                <div id="trophyRoomContent">
                    <!-- Populated by RewardsManager.renderTrophyRoom() -->
                </div>
            </div>
        `;
    }
